...
var grammar = {
    ...
    {"name": "specificSecondsItem", "symbols": ["secondsRangeIncremental"], "postprocess": id},
    {"name": "specificSecondsItem", "symbols": ["secondsRange"], "postprocess": id},
    {"name": "specificSecondsItem", "symbols": ["secondsIncremental"], "postprocess": id},
    ...
    {"name": "secondsRangeIncremental", "symbols": ["secondsRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('Seconds', 60)},
    ...
    {"name": "specificMinutesItem", "symbols": ["minutesRangeIncremental"], "postprocess": id},
    {"name": "specificMinutesItem", "symbols": ["minutesRange"], "postprocess": id},
    {"name": "specificMinutesItem", "symbols": ["minutesIncremental"], "postprocess": id},
    ...
    {"name": "minutesRangeIncremental", "symbols": ["minutesRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('Minutes', 60)},
    ...
    {"name": "specificHoursItem", "symbols": ["hoursRangeIncremental"], "postprocess": id},
    {"name": "specificHoursItem", "symbols": ["hoursRange"], "postprocess": id},
    {"name": "specificHoursItem", "symbols": ["hoursIncremental"], "postprocess": id},
    ...
    {"name": "hoursRangeIncremental", "symbols": ["hoursRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('Hours', 24)},
    ...
    {"name": "specificDaysItem", "symbols": ["dayOfMonthIncremental"], "postprocess": id},
    ...
    {"name": "dayOfMonthRangeIncremental", "symbols": ["dayOfMonthRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('dayOfMonth', 32, 1)},
    ...
    {"name": "specificMonthItem", "symbols": ["monthRangeIncremental"], "postprocess": id},
    {"name": "specificMonthItem", "symbols": ["monthRange"], "postprocess": id},
    {"name": "specificMonthItem", "symbols": ["monthIncremental"], "postprocess": id},
    ...
    {"name": "monthRangeIncremental", "symbols": ["monthRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('month', 13, 1)},
    {"name": "dayOfWeek", "symbols": ["_dayOfWeek"], "postprocess": unwrapAndAddScopeName('dayOfWeek')},
    {"name": "_dayOfWeek", "symbols": ["specificDayOfWeeks"]},
    {"name": "_dayOfWeek", "symbols": ["lastDayOfWeek"]},
    ...
    {"name": "specificDayOfWeekItem", "symbols": ["dayOfWeekRangeIncremental"], "postprocess": id},
    {"name": "specificDayOfWeekItem", "symbols": ["dayOfWeekRange"], "postprocess": id},
    {"name": "specificDayOfWeekItem", "symbols": ["dayOfWeekIncremental"], "postprocess": id},
    ...
    {"name": "dayOfWeekRangeIncremental", "symbols": ["dayOfWeekRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('dayOfWeek', 8, 1)},
    {"name": "lastDayOfWeek", "symbols": ["last"], "postprocess": d => ({ mode: 'specific', value: 7 })},
    ...
    {"name": "specificYearsItem", "symbols": ["yearsRangeIncremental"], "postprocess": id},
    {"name": "specificYearsItem", "symbols": ["yearsRange"], "postprocess": id},
    {"name": "specificYearsItem", "symbols": ["yearsIncremental"], "postprocess": id},
    {"name": "specificYear", "symbols": ["yearDigits"], "postprocess": convertDigitsToYear},
    {"name": "yearsIncremental", "symbols": ["yearDigits", {"literal":"/"}, "digits"], "postprocess": convertIncrementalFnFactory('Years', 2100, 1970)},
    {"name": "yearsIncremental", "symbols": [{"literal":"*"}, {"literal":"/"}, "digits"], "postprocess": convertIncrementalFnFactory('Years', 2100, 1970)},
    {"name": "yearsRange", "symbols": ["yearDigits", {"literal":"-"}, "yearDigits"], "postprocess": convertRangeFnFactory('Years', 2100, 1970)},
    {"name": "yearsRangeIncremental", "symbols": ["yearsRange", {"literal":"/"}, "digits"], "postprocess": convertRangeIncrementalFnFactory('Years', 2100, 1970)}
]
